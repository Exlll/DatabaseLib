...
public interface PreparationStrategy<T extends PreparedStatement> {
    /**
     ...
     */
    PreparationStrategy<PreparedStatement> PREPARED_STATEMENT_DEFAULT =
            Connection::prepareStatement;
    /**
     * A strategy object that creates {@code CallableStatement}s using
     * {@link Connection#prepareCall(String)}
     *
     * @see Connection#prepareCall(String)
     */
    PreparationStrategy<CallableStatement> CALLABLE_STATEMENT_DEFAULT =
            Connection::prepareCall;

    T prepare(Connection connection, String query) throws SQLException;
     ...
     */
    static PreparationStrategy<PreparedStatement> withAutoGeneratedKeys(int autoGeneratedKeys) {
     ...
     * @see Connection#prepareStatement(String, int[])
     */
    static PreparationStrategy<PreparedStatement> withColumnIndexes(int... columnIndexes) {
     ...
     */
    static PreparationStrategy<PreparedStatement> withColumnNames(String... columnNames) {
